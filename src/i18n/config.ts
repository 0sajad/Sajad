...
import enAiAssistantPage from '@/locales/en/ai-assistant.json';
...
import arAiAssistantPage from '@/locales/ar/ai-assistant.json';
...
import arSettingsPage from '@/locales/ar/settings-page.json';
...
import arIqAiAssistantPage from '@/locales/ar-iq/ai-assistant.json';
...
import arIqSettingsPage from '@/locales/ar-iq/settings-page.json';
...
import jaAiAssistantPage from '@/locales/ja/ai-assistant.json';
...
import frAiAssistantPage from '@/locales/fr/ai-assistant.json';
import frSettings from '@/locales/fr/settings.json';
import frSettingsPage from '@/locales/fr/settings-page.json';
...
import zhAiAssistantPage from '@/locales/zh/ai-assistant.json';
import zhCommon from '@/locales/zh/common.json';
import zhDashboard from '@/locales/zh/dashboard.json';
import zhSettingsPage from '@/locales/zh/settings-page.json';
...
const resources = {
  en: {
    ...
    aiAssistantPage: enAiAssistantPage,
    cta: enCta,
    access: enAccess,
    license: enLicense,
  ...
  ar: {
    ...
    aiAssistantPage: arAiAssistantPage,
    cta: arCta,
    access: arAccess,
    license: arLicense,
  ...
  'ar-iq': {
    ...
    aiAssistantPage: arIqAiAssistantPage,
    cta: arIqCta,
    access: arIqAccess,
  ...
  ja: {
    ...
    aiAssistantPage: jaAiAssistantPage,
    cta: jaCta,
    footer: jaFooter,
    hero: jaHero,
  ...
  fr: {
    ...
    aiAssistantPage: frAiAssistantPage,
    settings: frSettings,
  ...
  zh: {
    ...
    aiAssistantPage: zhAiAssistantPage,
