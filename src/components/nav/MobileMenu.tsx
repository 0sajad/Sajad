...
export function MobileMenu({ isOpen }: MobileMenuProps) {
  ...
  return (
    <div className="md:hidden fixed inset-x-0 top-[70px] z-40 bg-black/90 backdrop-blur-xl shadow-lg border-t border-orange-500/20 transition-all animate-fade-in">
